...
- git reset --soft HEAD~1
  - Push HEAD back by 1 commit in the history. File will move to the staging area.

- git reset --mixed HEAD~1
  - Push HEAD back by 1 commit in the history. File will move to the unstaged area.

- git reset --hard HEAD~1
  - Will delete the physical evidence of the file/ code from the system. 

- git revert <Commit_ID>
  - Professional way of rectifying the pushed mistakes on git. A new commit is created with the removed mistakes.

**"gh" Commands**

  - git repo create <repo name> --public --add-readme
    - Create a new repo directly from the terminal

  - gh clone <repo-url>
    - clone a repo using gh instead of git clone

  - git repo view <repo-url>
    - View the details of the repo from the terminal

  - git repo list 
    - list all the repos 

  - git repo view --web
    - view a repo in the web directly from the terminal

  - gh repo delete <repo-url> --confirm 
    - Delete a repo directly from the terminal
